...
class CountriesApi(object):
    ...
    @overload
    async def get_countries(self, **kwargs) -> List[Country]:  # noqa: E501
        ...

    @overload
    def get_countries(self, async_req: Optional[bool]=True, **kwargs) -> List[Country]:  # noqa: E501
        ...

    @validate_arguments
    def get_countries(self, async_req: Optional[bool]=None, **kwargs) -> Union[List[Country], Awaitable[List[Country]]]:  # noqa: E501
        """Country list  # noqa: E501

        Returns list of available countries  # noqa: E501
