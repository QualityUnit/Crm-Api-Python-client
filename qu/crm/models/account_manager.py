...
class AccountManager(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountManager:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountManager:
        """Create an instance of AccountManager from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountManager.parse_obj(obj)

        _obj = AccountManager.parse_obj({
