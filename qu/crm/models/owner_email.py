...
class OwnerEmail(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnerEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnerEmail:
        """Create an instance of OwnerEmail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OwnerEmail.parse_obj(obj)

        _obj = OwnerEmail.parse_obj({
